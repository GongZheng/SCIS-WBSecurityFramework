...
\begin{itemize}
\item \textit{Predicate VBBP(pvbbp)}
...
\subsection{Basic concepts: proposed security notions}
...
\begin{itemize}
\item For more general security, \textcolor{red}{the strong white-box security} has been defined by [Biryukov \textit{et al} 2014].
\end{itemize}
...
\subsection{Basic concepts: Application-oriented security notions}
