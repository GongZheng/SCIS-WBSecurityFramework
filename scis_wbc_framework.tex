...
\definition\cite{DBLP:conf/isw/SaxenaWP09,DBLP:conf/asiacrypt/BiryukovBK14} Let the pair of algorithms $(E, D)$ be a symmetric-key encryption scheme, which takes key $K$ as parameter. Let $\mathcal{O}_{E_{K}}$ be a function that computes $E_{K}$. We say that
\begin{itemize}
