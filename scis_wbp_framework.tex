...
\section{Definitions of White-Box Cryptography}
Loosely speaking, the white-box cryptography has been motivates from the white-box security. First we give heuristic definitions about the white-box and the black-box securities.
...
\item 1. \textit{(Functionality)}. $\forall k, \forall (q,a)\in \mathcal{K}^{k}_{Q}\times \mathcal{I}^{k}_{Q}:\textmd{Pr}[\mathcal{O}(Q,k)(a) \neq Q [k](a)]\leq negl(k)$
